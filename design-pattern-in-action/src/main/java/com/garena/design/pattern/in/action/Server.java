...
import com.garena.design.pattern.in.action.interceptor.impl.BinaryInterceptor;
import com.garena.design.pattern.in.action.interceptor.impl.CompressInterceptor;
import com.garena.design.pattern.in.action.interceptor.impl.EncryptInterceptor;
import com.garena.design.pattern.in.action.interceptor.impl.JSONInterceptor;
import com.garena.design.pattern.in.action.interceptor.impl.MessageContextImpl;
...
public class Server extends Thread implements MessageListener {
    ...
    public Server() throws IOException {
        ...
        this.pipeline.attach(new BinaryInterceptor());
        this.pipeline.attach(new EncryptInterceptor());
        this.pipeline.attach(new CompressInterceptor());
        this.pipeline.attach(new JSONInterceptor());
    }
