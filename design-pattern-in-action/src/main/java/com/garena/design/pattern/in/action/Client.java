...
import com.garena.design.pattern.in.action.impl.ConnectionImpl;
...
public class Client implements MessageListener {
    ...
    public Client() {
        ...
        pipeline.attach(new BinaryInterceptor());
        pipeline.attach(new EncryptInterceptor());
        pipeline.attach(new CompressInterceptor());
        pipeline.attach(new JSONInterceptor());
